...
extension LatersOperationTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__LatersOperationTests = [
        ("testOneOperation", testOneOperation),
        ("testThreeOperationsWithDependencies", testThreeOperationsWithDependencies),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(LatersOperationTests.__allTests__LatersOperationTests),
